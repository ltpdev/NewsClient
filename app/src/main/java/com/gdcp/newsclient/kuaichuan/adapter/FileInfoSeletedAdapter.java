...
public class FileInfoSeletedAdapter extends BaseAdapter {
    ...
    private Map<String,FileInfo>dataHashMap;
    ...
    public void notifyDataSetChanged() {
        dataHashMap=APPAplication.getAppContext().getFileInfoMap();
        fileInfoMapList = new ArrayList<Map.Entry<String, FileInfo>>(dataHashMap.entrySet());
        Collections.sort(fileInfoMapList, Constant.DEFAULT_COMPARATOR);
        super.notifyDataSetChanged();
    }

    public FileInfoSeletedAdapter(Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView=View.inflate(context, R.layout.item_transfer,null);
        ...
        if (fileInfo!=null){
            ...
            viewHolder.iv_tick.setImageBitmap(BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_del));
            if (FileUtils.isApkFile(fileInfo.getFilePath())||FileUtils.isMp4File(fileInfo.getFilePath())){
                ...
                viewHolder.iv_shortcut.setImageDrawable(context.getResources().getDrawable(R.mipmap.icon_mp3));
            }
            ...
            viewHolder.iv_tick.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    APPAplication.getAppContext().getFileInfoMap().remove(fileInfo.getFilePath());
